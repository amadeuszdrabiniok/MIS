...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.nextDay = QPushButton(Widget)
        self.nextDay.setObjectName(u"StopButton")
        self.nextDay.setGeometry(QRect(20, 450, 80, 22))
    ...
    def retranslateUi(self, Widget):
        ...
        self.nextDay.setText(QCoreApplication.translate("Widget", u"nextDay", None))
